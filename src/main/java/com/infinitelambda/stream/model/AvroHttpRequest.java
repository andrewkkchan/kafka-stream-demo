...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.infinitelambda.stream.model.ClientIdentifier clientIdentifier;
  @Deprecated public java.util.List<java.lang.CharSequence> employeeNames;
  @Deprecated public com.infinitelambda.stream.model.Active active;
   ...
   */
  public AvroHttpRequest(java.lang.Long requestTime, com.infinitelambda.stream.model.ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames, com.infinitelambda.stream.model.Active active) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: clientIdentifier = (com.infinitelambda.stream.model.ClientIdentifier)value$; break;
    case 2: employeeNames = (java.util.List<java.lang.CharSequence>)value$; break;
    case 3: active = (com.infinitelambda.stream.model.Active)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.infinitelambda.stream.model.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(com.infinitelambda.stream.model.ClientIdentifier value) {
   ...
   */
  public com.infinitelambda.stream.model.Active getActive() {
    return active;
  }
   ...
   * @param value the value to set.
   */
  public void setActive(com.infinitelambda.stream.model.Active value) {
    this.active = value;
  }
   ...
   */
  public static com.infinitelambda.stream.model.AvroHttpRequest.Builder newBuilder() {
    return new com.infinitelambda.stream.model.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.infinitelambda.stream.model.AvroHttpRequest.Builder newBuilder(com.infinitelambda.stream.model.AvroHttpRequest.Builder other) {
    return new com.infinitelambda.stream.model.AvroHttpRequest.Builder(other);
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.infinitelambda.stream.model.AvroHttpRequest.Builder newBuilder(com.infinitelambda.stream.model.AvroHttpRequest other) {
    return new com.infinitelambda.stream.model.AvroHttpRequest.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private com.infinitelambda.stream.model.ClientIdentifier clientIdentifier;
    private com.infinitelambda.stream.model.ClientIdentifier.Builder clientIdentifierBuilder;
    private java.util.List<java.lang.CharSequence> employeeNames;
    private com.infinitelambda.stream.model.Active active;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.infinitelambda.stream.model.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = com.infinitelambda.stream.model.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.infinitelambda.stream.model.AvroHttpRequest other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.infinitelambda.stream.model.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.infinitelambda.stream.model.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.infinitelambda.stream.model.AvroHttpRequest.Builder setClientIdentifier(com.infinitelambda.stream.model.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public com.infinitelambda.stream.model.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(com.infinitelambda.stream.model.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(com.infinitelambda.stream.model.ClientIdentifier.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.infinitelambda.stream.model.AvroHttpRequest.Builder setClientIdentifierBuilder(com.infinitelambda.stream.model.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.infinitelambda.stream.model.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.infinitelambda.stream.model.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.infinitelambda.stream.model.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.infinitelambda.stream.model.AvroHttpRequest.Builder setActive(com.infinitelambda.stream.model.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.infinitelambda.stream.model.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        if (clientIdentifierBuilder != null) {
          ...
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (com.infinitelambda.stream.model.ClientIdentifier) defaultValue(fields()[1]);
        }
        record.employeeNames = fieldSetFlags()[2] ? this.employeeNames : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
        record.active = fieldSetFlags()[3] ? this.active : (com.infinitelambda.stream.model.Active) defaultValue(fields()[3]);
        return record;
